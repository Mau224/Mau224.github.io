...
const slidersz = document.querySelectorAll('.slider');
...
let slider_sert_second = new Swiper('.slider-sert-second', {
	slidesPerView: 4,
	observer: true,
	observeParents: true,
	speed: 800,
...
let spoiler = document.querySelectorAll('.spoiler-only-mob');

for (let i = 0; i < slider.length; i++) {
    if (window.innerWidth > 767) {
        slider[i].classList.remove('_swiper');
        slider[i].classList.remove('slider');
        slider[i].classList.remove('slider-rev');
    }
}

for (let i = 0; i < slider.length; i++) {
    if (window.innerWidth < 767) {
        slider[i].classList.add('_swiper');
        slider[i].classList.add('slider');
        slider[i].classList.add('slider-rev');
    }
}
...
for (let i = 0; i < arrows.length; i++) {
    if (window.innerWidth < 767) {
        arrows[i].classList.remove('swiper-slide');
    }
}
...
for (let i = 0; i < spoiler.length; i++) {
    if (window.innerWidth > 767) {
        spoiler[i].classList.remove('_spoilers');
    }
}
