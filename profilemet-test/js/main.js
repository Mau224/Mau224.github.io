...
var bestItemWidth = bestItem.innerWidth() * bestItem.length;
console.log(bestItem.css('width'));
console.log(bestItem.length);
console.log(bestItemWidth);
...
// появление оранжевых регионов на карте РФ
  ...
  ScrollTrigger.create({
    ...
    onEnter: function(){
      setTimeout(
        function(){
          $('.svg-item').css('fill', '#FCD5B3');
          $('.map-logo').addClass('showing')
        }, 3000
      )
...
// let mapLink = document.querySelector('.svg-item');
// let mapBlock = document.querySelector('.home-map__info');
// mapLink.forEach(el => {
//   el.addEventListener('click', (e) => {
//     mapBlock.classList.add('.show-map-modal')
//   });
// });
